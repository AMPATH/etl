...
(select * from amrs.obs o use index (date_created) where concept_id in (1592,9081,9062,9063,9067,9069,1558,1553,1559,1552,1816,9073,1568,1569,1733,1570,1573,1588,9077,9082,1583,5096) and o.voided=0 and date_created > @last_obs_date_created);
