...
from amrs.obs o
where concept_id in (1088,1941,5096,1502,1777,1285,1596,6206,1733,1042,1559,1725,1040,1579,1499,1255,856,5497,730,1250) and o.voided=0 and encounter_id is not null
group by encounter_id 
);


select @index := max(encounter_id) + 10000000 from amrs.encounter;
...
if(lab_cd4_percent >= 0,lab_cd4_percent,if(enc_cd4_percent >= 0,enc_cd4_percent,null)) as cd4_percent
from ltfu_1
order by person_id, encounter_datetime, encounter_id desc
);
*/
