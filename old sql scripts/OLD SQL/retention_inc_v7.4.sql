...
select @last_enc_date_created := '2014-05-23';
...
select @last_obs_date_created := '2014-05-23';
...
(select * from amrs.obs o where concept_id in (1285,1946,5096,1502,1777,1088,1255,1250,9082,1596) and o.voided=0 and date_created > @last_obs_date_created);
