...
(select * from amrs.obs o use index (encounter_date_created) where concept_id in (1109,1112,1193,1261,1263,1277,1278,1637,1668,1879,1895,2250,8346) and o.voided=0 and date_created > @last_update);
...
insert ignore into obs_subset
(select o.* from amrs.encounter e join amrs.obs o use index (encounter_date_created) using (encounter_id) where o.date_created > @last_update and o.voided=0 and e.date_created <= @last_update and e.voided=0 and o.concept_id in (1109,1112,1193,1261,1263,1277,1278,1637,1668,1879,1895,2250,8346));
