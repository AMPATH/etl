...
select @table_version := "flat_lab_obs_v1.2";
...
(select distinct person_id, obs_datetime
	...
	where voided=1
		...
		and concept_id in (856,5497,730,21,653,790,12,1030,1040,1271,9239,9020,9508)
...
(select
	...
	where
		o.concept_id in (856,5497, 730,21,653,790,12,1030,1040,1271,9239,9020,9508)
