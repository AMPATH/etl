...
else if location_id in(5,63,6,85,8,64,75,76,74,12,65,9,66,67,59,19,26,27,81,20,23,83,79,78,55,86,87,89,90,91,92,93,96,97,99,100,106) then do; Province='WESTERN';end;
