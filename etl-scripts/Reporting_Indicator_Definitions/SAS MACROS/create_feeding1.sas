...
keep person_id feeding_date feeding ;
run;

proc sort data=feeding1 nodupkey; by person_id feeding_date feeding; run;

proc transpose data=feeding1 out=feedingT prefix=feeding;
