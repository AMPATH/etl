...
(select obs_id, obs_datetime, person_id, encounter_id, concept_id,value_coded, value_numeric,value_datetime,date_created,voided,date_voided
	from amrs.obs o
		where (voided=0 or date_voided >= @start_date) and o.date_created <= @start_date and concept_id in (1285,1946,5096,1502,1777,1042,1040,1088,1255,1250,856,5497,730,9082)
);
