...
create table if not exists flat_person_data
(person_id int,gender varchar(10),birthdate datetime,person_name varchar(500),phone_number varchar(100),identifier varchar(50), index person_id (person_id));

select @last_person_date_created := max(enc_date_created) from flat_retention_defined;
