...
# v1.7 Notes:
#      Added in concepts for GENEXPERT IMAGE and DRUG SENSITIVITY IMAGE
#      Changed logging to include timestamp

select @table_version := "flat_lab_obs_v1.7";
	...
	where voided=1
		...
		and concept_id in (856,5497,730,21,653,790,12,1030,1040,1271,9239,9020,9508, 6126, 887, 6252, 1537, 857,
				   679,21,851,1018,1017,1016,729,678,1330,6134,790,1132,1133,1134,655,1297,6123,
                                   653,654,717,848,785,1014,10249,10250,10251,9010,9011,9699,9012,9812,10304,10313)
