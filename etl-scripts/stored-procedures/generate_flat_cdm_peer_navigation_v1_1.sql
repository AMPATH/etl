DELIMITER $$
CREATE PROCEDURE `generate_flat_cdm_peer_navigation_v1_1`(IN query_type varchar(50), IN queue_number int, IN queue_size int, IN cycle_size int)
BEGIN
    ...
    table_name = @table_version;
                    ...
                    while @person_ids_count > 0 do
                        ...
                        (select
                            ...
                            where t1.encounter_type in (192,193)
                        );
