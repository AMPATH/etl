DELIMITER $$
CREATE PROCEDURE `generate_hiv_monthly_report_dataset_v1_3`(IN query_type varchar(50), IN queue_number int, IN queue_size int, IN cycle_size int, IN start_date varchar(50))
BEGIN

			set @start = now();
			set @table_version = "hiv_monthly_report_dataset_v1.3";
