DELIMITER $$
CREATE PROCEDURE `generate_flat_onc_patient_history`(IN query_type varchar(50), IN queue_number int, IN queue_size int, IN cycle_size int)
BEGIN
        ...
        WHILE @person_ids_count > 0 DO
          ...
          (SELECT 
            ...
            CASE 
                WHEN obs regexp "!!6251=" THEN @breast_exam_findings := GetValues(obs, 6251)
