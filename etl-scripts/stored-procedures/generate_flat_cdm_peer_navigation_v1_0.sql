DELIMITER $$
CREATE  PROCEDURE `generate_flat_cdm_peer_navigation_v1_0`(IN query_type varchar(50), IN queue_number int, IN queue_size int, IN cycle_size int)
BEGIN
                    ...
                    set @start = now();
                    set @table_version := "flat_cdm_peer_navigation_v1.0";
...
CREATE TABLE IF NOT EXISTS flat_cdm_peer_navigation (
    ...
    referal_category SMALLINT,
    lifestyle_modification_plan INT,
    current_medication_regimen INT,
    understand_bp_meds_and_purpose INT,
    understand_meds_frequency INT,
    last_hypersenitive_regimen_change INT,
    missed_bp_meds_7days INT,
...
SELECT 'table created  ...';
    ...
    if (@query_type="sync") then
							select 'SYNCING..........................................';
							set @write_table = "flat_cdm_peer_navigation_test";
    ...
    table_name = @table_version;
                    ...
                    while @person_ids_count > 0 do
                        ...
                        (select
                            ...
                            case
                                when t1.encounter_type in (193,194) then 1
                                else null
                            end as is_clinical_encounter,

                            case
                                when t1.encounter_type in (116) then 20
                                when t1.encounter_type in (3,4,115) then 10
                            ...
                            where t1.encounter_type in (193,194)
                        );
                        ...
                        (select
                            ...
                            #t1.date_created,
							case
								when obs regexp "!!10494=8989!!" then @referal_category := 1
								when obs regexp "!!10494=7316!!" then @referal_category := 2
								else @referal_category := null
							end as referal_category,
                            case
							...
							case
                                ...
                                when obs regexp "!!1668=1664!!" then @reason_meds_missed := 1
								when obs regexp "!!1668=6295!!" then @reason_meds_missed := 2
                                when obs regexp "!!1668=6100!!" then @reason_meds_missed := 1
								when obs regexp "!!1668=1546!!" then @reason_meds_missed := 2
                                when obs regexp "!!1668=1647!!" then @reason_meds_missed := 1
								when obs regexp "!!1668=9126!!" then @reason_meds_missed := 2
                                when obs regexp "!!1668=10453!!" then @reason_meds_missed := 2
                                when obs regexp "!!1668=1548!!" then @reason_meds_missed := 1
								when obs regexp "!!1668=5622!!" then @reason_meds_missed := 2
							...
							case
                                ...
                                when obs regexp "!!10459=10457!!" then @barries_to_complete_referral := 1
								when obs regexp "!!10459=1578!!" then @barries_to_complete_referral := 2
                                when obs regexp "!!10459=10455!!" then @barries_to_complete_referral := 1
								when obs regexp "!!10459=820!!" then @barries_to_complete_referral := 2
                                when obs regexp "!!10459=1576!!" then @barries_to_complete_referral := 1
								when obs regexp "!!10459=1577!!" then @barries_to_complete_referral := 2
                                when obs regexp "!!10459=1666!!" then @barries_to_complete_referral := 2
                                when obs regexp "!!10459=10456!!" then @barries_to_complete_referral := 1
								when obs regexp "!!10459=1915!!" then @barries_to_complete_referral := 2
							...
							case
                                ...
                                when obs regexp "!!10467=10465!!" then @referal_preparation_discussed := 1
								when obs regexp "!!10467=10466!!" then @referal_preparation_discussed := 2
