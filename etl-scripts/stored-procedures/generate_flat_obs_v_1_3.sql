DELIMITER $$
CREATE  PROCEDURE `generate_flat_obs_v_1_3`()
BEGIN
...
(select
        ...
        group_concat(
                case
                        when value_drug is not null then concat(@boundary,value_coded,'_drug','=',value_drug,@boundary,@drug_separator,@boundary,o.concept_id,'=',value_coded,@boundary)
