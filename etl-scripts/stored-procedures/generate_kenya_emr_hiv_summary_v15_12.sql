DELIMITER $$
CREATE  PROCEDURE `generate_kenya_emr_hiv_summary_v15_12`(IN query_type varchar(50), IN queue_number int, IN queue_size int, IN cycle_size int)
BEGIN
...
*/
                            ...
                            case
                                ...
                                when obs regexp "!!10792=10793!!" AND obs regexp "!!1499=" then @arv_start_date := GetValues(obs,'1499')
