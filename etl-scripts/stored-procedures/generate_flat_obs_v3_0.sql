CREATE PROCEDURE `generate_flat_obs_v_3_0`(IN query_type varchar(50), IN queue_number int, IN queue_size int, IN cycle_size int)
BEGIN
    ...
    WHILE @person_ids_count > 0 do
        ...
        CREATE temporary table flat_obs__0 (
            select o.person_id,
                case
