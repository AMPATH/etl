DELIMITER $$
CREATE  PROCEDURE `generate_surge_weekly_report_dataset_v4`(IN query_type varchar(50), IN queue_number int, IN queue_size int, IN cycle_size int , IN log boolean)
BEGIN
