CREATE DEFINER=`fmaiko`@`%` PROCEDURE `etl`.`generate_kenya_emr_hiv_summary_v15_12`(IN query_type varchar(50), IN queue_number int, IN queue_size int, IN cycle_size int)
BEGIN
                        ...
                        (select
                         ...
                         END AS enrollment_location_id,
                            ...
                            case
                                ...
                                when obs regexp "!!1246=1065" then '1246'
                            ...
                            case
                              ...
                              when obs regexp "!!10994=" then @mdt_session_number:= GetValues('10994',obs)
...
*/
                            ...
                            case
                                ...
                                when obs regexp "!!10792=10793!!" AND obs regexp "!!1499=" then @arv_start_date := GetValues('1499',obs)
