DELIMITER $$
CREATE  PROCEDURE `generate_hiv_summary_v15_7`(IN query_type varchar(50), IN queue_number int, IN queue_size int, IN cycle_size int)
BEGIN
                    ...
                    while @person_ids_count > 0 do
                        ...
                        (select
                         ...
                         END AS enrollment_location_id,
                            ...
                            END AS arv_first_regimen_start_date_flex,
