...
CREATE TABLE IF NOT EXISTS flat_hiv_summary_v15b (
    ...
    INDEX last_non_transit_location_id_rtc_date (last_non_transit_location_id , rtc_date),
    INDEX last_non_transit_location_id_enc_date_next_clinical (last_non_transit_location_id , encounter_datetime , next_clinical_datetime_hiv)
);
...
SELECT @person_ids_count AS 'num patients to sync';
                    ...
                    while @person_ids_count > 0 do
                        ...
                        (select
							...
							where (t1.encounter_type in (1,2,3,4,10,14,15,17,19,22,23,26,32,33,43,47,21,105,106,110,111,112,113,114,116,117,120,127,128,129,138,140,153,154,158,161,162,163,212,214,218,220,225,226,253)
