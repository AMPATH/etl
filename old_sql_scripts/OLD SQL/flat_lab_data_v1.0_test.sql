...
(select e.encounter_id, e.encounter_datetime, e.provider_id, e.patient_id as person_id, e.location_id,e.encounter_type, e.date_created as enc_date_created,voided, date_voided
...
alter table enc drop date_voided, drop voided;
