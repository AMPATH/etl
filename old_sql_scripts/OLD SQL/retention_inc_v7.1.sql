...
and e.encounter_type in (1,2,3,4,10,11,12,14,15,17,19,26,44,46,47,21) 
...
where o.date_created > @last_obs_date_created and o.voided=0 and e.date_created <= @last_enc_date_created and e.voided=0 and concept_id in (1285,1946,5096,1502,1777,1088,1255,1250,9082)  and encounter_type in (1,2,3,4,10,11,12,14,15,17,19,26,44,46,47,21) 
...
case
	when encounter_type in (1,2,3,4,10,11,12,14,15,17,19,26,44,46,47) then @cur_clinic_date := encounter_datetime
...
case
	...
	when encounter_type in (1,2,3,4,10,11,12,14,15,17,19,26,44,46,47)  then @cur_ampath_status := 6101
...
select person_id, encounter_datetime,arv_meds, arv_meds_plan, arv_plan, prev_arv_line, cur_arv_line from flat_retention_derived_3; 
...
(select encounter_id,person_id,prev_encounter_type,prev_rtc_date,prev_appt_date,hiv_start_date,arv_start_date,next_encounter_type,next_appt_date, prev_hiv_clinic_date, next_hiv_clinic_date, cur_ampath_status
