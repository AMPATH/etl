...
# Renamed new_data_person_ids table to flat_hiv_summary_build_queue_2 and made it permanent
...
use etl;
drop procedure if exists generate_hiv_summary_v15_3;
					...
					while @person_ids_count > 0 do
						...
						(select
						    ...
						    case
								...
								when t1.encounter_type in (1,2,3,4,10,14,15,17,19,26,32,33,34,47,105,106,112,113,114,115,117,120,127,128,138, 153,154,158) then 10
						...
						set @first_evidence_pt_pregnant = null;
						set @edd = null;
						...
						(select
							...
							case
								...
								when obs regexp "!!1250=" then
									replace(replace((substring_index(substring(obs,locate("!!1250=",obs)),@sep,ROUND ((LENGTH(obs) - LENGTH( REPLACE ( obs, "!!1250=", "") ) ) / LENGTH("!!1250=") ))),"!!1250=",""),"!!","")
								when obs regexp "!!1088=" then
									replace(replace((substring_index(substring(obs,locate("!!1088=",obs)),@sep,ROUND ((LENGTH(obs) - LENGTH( REPLACE ( obs, "!!1088=", "") ) ) / LENGTH("!!1088=") ))),"!!1088=",""),"!!","")
								when obs regexp "!!2154=" then
									replace(replace((substring_index(substring(obs,locate("!!2154=",obs)),@sep,ROUND ((LENGTH(obs) - LENGTH( REPLACE ( obs, "!!2154=", "") ) ) / LENGTH("!!2154=") ))),"!!2154=",""),"!!","")
								else null
