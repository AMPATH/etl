...
else if location_id in(99) then do; HealthCentre='LUPIDA';end;
...
else if location_id in(19,26,27,81,79,99) then do; District='BUSIA';end;
...
if location_id in(1,13,77,14,56,58,15,2,70,3,60,4,62,54,11,82,57,17,18,10,68,31,61,69,71,80,72,84,73,28,88,94,95,98) then do; Province='NORTH RIFT';end;
