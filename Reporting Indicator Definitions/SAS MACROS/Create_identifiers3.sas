...
/* get those who have the invalid Ampath Id*/
data identifier5(keep=person_id identifier location_id identifier_type preferred);
set identifier;
/***AMPATH ID***/
...
proc sort data=identifier5 nodupkey out=dup1 ; by person_id; run;


/* Bring the different edentifiers together*/
data ident;
set identifier3 identifier1 identifier8 identifier4 identifier5;
...
PROC DATASETS LIBRARY=WORK NOLIST;
		DELETE dup1 dup3 ident ident1 Identifier8 ident2 identifier identifier1 identifier3 
identifier4 identifiers patient_identifier identifier5;
		RUN;
   		QUIT;
