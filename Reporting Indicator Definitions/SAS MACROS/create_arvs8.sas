...
/*proc sort data=arvs_a1;by person_id;run;*/
/*proc sort data=arvs_b1;by person_id;run;*/

data arvs;
set arvs_a1(rename=(encounter_id1=encounter_id)) 
arvs_b1(rename=(encounter_id1=encounter_id));
/*by person_id;*/
run;
