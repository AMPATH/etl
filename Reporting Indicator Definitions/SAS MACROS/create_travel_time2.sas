...
data travellcode;
set travell_T;
if  value_coded=1049 then travel_time='a:LESS THAN 30 MINUTES';
else if value_coded=1050 then travel_time='b:30 TO 60 MINUTES';
else if value_coded=1051 then travel_time='c:ONE TO TWO HOURS';
else if value_coded=1052 then travel_time='d:MORE THAN TWO HOURS';
else if value_coded=6412 then travel_time='e:TWO TO FOUR HOURS';
else if value_coded=6413 then travel_time='f;FOUR TO EIGHT HOURS';
else if value_coded=6414 then travel_time='g:MORE THAN EIGHT HOURS';
run;
