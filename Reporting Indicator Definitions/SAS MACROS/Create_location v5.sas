...
if location_id in(94) then do; site='Iten'; end;
if location_id in(98) then do; site='Mosoriot'; end;
if location_id in(99) then do; site='Nambale'; end;
...
else if location_id in(93) then do; HealthCentre='OBEKAI';end;
else if location_id in(94) then do; HealthCentre='TAMBACH';end;
else if location_id in(95) then do; HealthCentre='TENGES';end;
else if location_id in(96) then do; HealthCentre='KIBISI';end;
else if location_id in(97) then do; HealthCentre='SANGO';end;
else if location_id in(98) then do; HealthCentre='AIC DIGUNA';end;
else if location_id in(99) then do; HealthCentre='LUPIDA HC';end;
else if location_id in(100) then do; HealthCentre='OSIEKO';end;
else if location_id in(102) then do; HealthCentre='ELGEYO BORDER';end;
...
else if location_id in(17,94) then do; District='KEIYO NORTH';end;
...
else if location_id in(79,99) then do; District='NAMBALE';end;
...
if location_id in(1,13,77,14,56,58,15,2,70,3,60,4,62,54,11,82,57,17,18,10,68,31,61,69,71,80,72,84,73,28,88,94,95,98,102) then do; Province='NORTH RIFT';end;
else if location_id in(5,63,6,85,8,64,75,76,74,12,65,9,66,67,59,19,26,27,81,20,23,83,79,78,55,86,87,89,90,91,92,93,96,97,99,100) then do; Province='WESTERN';end;
