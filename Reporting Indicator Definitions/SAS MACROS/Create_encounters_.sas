...
set encounters1a;
if encounter_date>=mdy(10,01,2014) and encounter_type=21 then do; encounter_date=mdy(09,30,2014);end; 
run;


PROC DATASETS LIBRARY=WORK NOLIST;
		DELETE encounters1 encounters2 encounters encounters1a;
		RUN;
   		QUIT;
